...
\begin{algorithmic}
 ...
 \State Store all the $\mu_j$ in $\mu$
  \State Multiply $\omega$ along the $j$ dimesion of $\mu$.
 \\ \Return $\mu$
 \end{algorithmic}
