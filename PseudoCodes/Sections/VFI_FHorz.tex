...
\begin{algorithmic}
 \State Solve for final period, $N_j$: $V_{N_j}(a,z)=\max_{d,a' \in D(a,z)} \left\{ F(d,a',a,z) \right\}$
...
The main difference is that the expectations term is now more complex.
